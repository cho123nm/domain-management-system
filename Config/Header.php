...
// Đảm bảo các biến cần thiết luôn có giá trị
...
<html lang="en">
<head>
		<title> <?=strtoupper($_SERVER['SERVER_NAME']);?> - <?=$CaiDatChung['tieude'];?> </title>
		<meta charset="utf-8" />
		<meta name="description" content="<?=$CaiDatChung['mota'];?>" />
		<meta name="keywords" content="<?=$CaiDatChung['keywords'];?>" />
						...
						<div class="app-container container-xxl d-flex align-items-stretch justify-content-between">
							...
							<div class="app-navbar gap-2">
								...
								<div class="app-navbar-item">
									...
									<div class="btn btn-icon btn-color-white bg-hover-white bg-hover-opacity-10 lh-1 position-relative" id="kt_drawer_chat_toggle">
								...
								<div class="app-navbar-item" id="kt_header_user_menu_toggle">
									...
									?>
										...
										<div class="menu-item px-5">
											<a href="/profile" class="menu-link px-5"> Trang Cá Nhân </a>
										</div>
										
										
										<div class="menu-item px-5">
											<a href="/Manager" class="menu-link px-5">
										...
										<div class="menu-item px-5">
											<a href="/Recharge" class="menu-link px-5"> Nạp Tiền </a>
										</div>
										...
										<div class="menu-item px-5">
											<a href="/auth/logout" class="menu-link px-5"> Đăng Xuất </a>
										</div>
									...
									?>
										...
										<div class="menu-item px-5 my-1">
											<a href="/auth/login" class="menu-link px-5"> Đăng Nhập </a>
										</div>
										
										
										<div class="menu-item px-5">
											<a href="/auth/register" class="menu-link px-5"> Đăng Ký </a>
										</div>
							...
							<div class="header-menu d-flex align-items-stretch w-100">
								...
								<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-state-primary menu-title-gray-700 menu-arrow-gray-400 menu-bullet-gray-400 fw-semibold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
									...
									<div class="menu-item">
										...
										<a class="menu-link py-3" href="/Recharge">
											<span class="menu-title">
										...
										<a class="menu-link py-3" href="/Manager">
											<span class="menu-title">
