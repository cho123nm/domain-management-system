...
<div class="col-lg-8">
    ...
    <span class="fw-bolder text-success fs-6"> 0856761038 
...
<div class="col-lg-8">
    ...
    <span class="fw-bolder text-danger fs-6"> Admin_VUDZ<?=$users['id'];?> 
...
<div class="col-lg-8">
    ...
    <span class="fw-bolder text-warning fs-6">Vui lòng ghi chính xác nội dung chuyển tiền.
</span>
...
<div class="col-lg-8">
    ...
    <span class="fw-bolder text-success fs-6"> 6151099464 
